...
[stop-slop](https://github.com/hvpandya/stop-slop) 是英文写作领域最火的"去 AI 味"规则集——它用极简的规则、速查清单和评分系统，教 AI 洗掉那些一眼假的写作套路。Stop Slop CN 是它的中文版，**针对中文写作场景从零重写**，不是简单翻译。
...
规则框架受 [stop-slop](https://github.com/hvpandya/stop-slop) 启发，作者 [Hardik Pandya](https://hvpandya.com)。中文规则为独立创作，针对中文写作场景从零构建。